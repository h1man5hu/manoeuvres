...
class MovesDatabaseHelper {
    ...
    static void loadMove(Friend friend, String moveId, boolean inProgress, final MovesPresenter.LoadMoveListener listener) {
            ...
            reference.child(Constants.FIREBASE_DATABASE_REFERENCE_MOVES_PRESENT).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if (listener != null) {
                        ...
                        if (value != null) {
                            listener.onMoveLoaded(value.toString());
    ...
    static DatabaseReference getMovesDataReference(@NonNull String userId) {
        return (FirebaseDatabase.getInstance().getReference(Constants.FIREBASE_DATABASE_REFERENCE_MOVES)
                .child(userId));
    }
