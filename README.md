...
* Each presenter also has a <i>DatabaseHelper</i> class which contains only static methods. The presenters delegates one-time reading/writing operations to these database helpers. 
...
#Optimizations
* Used memory-efficient collections<br />
![ArrayMap](http://i.imgur.com/Gwufx5f.png)
* Reduced instance allocations<br />
![Re-UseInstances](http://i.imgur.com/nofYYF2.png)
* Used _for_ loop instead of for-each<br />
